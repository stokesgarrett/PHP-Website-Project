...
if (isset($_SESSION['name']) && isset($_SESSION['age']) && isset($_SESSION['gender']) &&
    ...
    // Check if a flag indicating data submission exists in the session
    if (!isset($_SESSION['data_submitted'])) {
        ...
        if ($stmt->execute()) {
            ...
            // Set a flag to indicate data submission
        ...
        echo "Data has already been submitted.";
    }
}
?>
