...
<html>
  ...
  <body>
    ...
    <div class="fade-in3">
    <h2> it's time to get away.</h2>
    </div>
    <div class="fade-in6">
    <h1> but where? that's up to how you are feeling. </h1>
    <h3> what it is it that you truly desire? </h3>
    <h4> who even are you? </h4>
    <a href="getting_away.php" class="learnmorebutton">proceed &RightArrow;</a>
    </div>
  <div class ="footer">
  </div>
  </body>
